      ...
      <section className=" max-w-screen-xl w-full   mx-auto">
        ...
        <main className="flex justify-start  flex-col gap-5 ">
          <article className="text-pretty font-poppins leading-6 max-w-screen-md pb-20">
            ...
            permite tener un entorno de desarrollo consistente y portátil. Para
            la implementación continua y la entrega continua (CI/CD),
            ...
            de código. Utilizamos NGINX como un proxy inverso para servir todos
            los servicios del backend y el frontend, mejorando la eficiencia y
